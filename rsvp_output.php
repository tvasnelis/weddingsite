              ...
              <?php }
                // display rsvp for Plus One
                    ...
                    <fieldset class="PlusOne_info">
                      ...
                      <input type="text" name="PlusOne_firstname" id="PlusOne_firstname" class=<?php echo "'guest_name"; if (isset($errors['PlusOne_firstname'])) {echo " error-border";} echo "'"?> value="<?php if (isset($PlusOne['firstname'])) {echo htmlspecialchars($PlusOne['firstname']);} ?>" />
                      <label for="PlusOne_lastname" class="guest_name">Last: </label>
                      <input type="text" name="PlusOne_lastname" id="PlusOne_lastname" class=<?php echo "'guest_name"; if (isset($errors['PlusOne_lastname'])) {echo " error-border";} echo "'"?> value="<?php if (isset($PlusOne['lastname'])) {echo htmlspecialchars($PlusOne['lastname']);} ?>" />
          	        </fieldset>
          	       </div>
          			<?php
          			}
                // display rsvp for Plus Family
                  ...
                  echo "<label for='family_cnt_4' class='family_cnt form_button'>4</label>";
                    ...
                    <input type="text" name="family[1][firstname]" id="family_1_firstname" class=<?php echo "'guest_name"; if (isset($errors['family_firstname'][1])) {echo " error-border";} echo "'"?>
                    ...
                    <input type="text" name="family[1][lastname]" id="family_1_lastname" class=<?php echo "'guest_name"; if (isset($errors['family_lastname'][1])) {echo " error-border";} echo "'"?>
                  ...
                  <div id="ifTwo" style="display:none">
                    ...
                    <input type="text" name="family[2][firstname]" id="family_2_firstname" class=<?php echo "'guest_name"; if (isset($errors['family_firstname'][2])) {echo " error-border";} echo "'"?>
                    ...
                    <input type="text" name="family[2][lastname]" id="family_2_lastname" class=<?php echo "'guest_name"; if (isset($errors['family_lastname'][2])) {echo " error-border";} echo "'"?>
                  ...
                  <div id="ifThree" style="display:none">
                    ...
                    <input type="text" name="family[3][firstname]" id="family_3_firstname" class=<?php echo "'guest_name"; if (isset($errors['family_firstname'][3])) {echo " error-border";} echo "'"?>
                      value="<?php if (isset($family[3]['firstname'])) {echo htmlspecialchars($family[3]['firstname']);} ?>" />
                    <label for="family_3_lastname" class="guest_name">Last: </label>
                    <input type="text" name="family[3][lastname]" id="family_3_lastname" class=<?php echo "'guest_name"; if (isset($errors['family_lastname'][3])) {echo " error-border";} echo "'"?>
                  ...
                  <div id="ifFour" style="display:none">
                    ...
                    <input type="text" name="family[4][firstname]" id="family_4_firstname" class=<?php echo "'guest_name"; if (isset($errors['family_firstname'][4])) {echo " error-border";} echo "'"?>
                    ...
                    <input type="text" name="family[4][lastname]" id="family_4_lastname" class=<?php echo "'guest_name"; if (isset($errors['family_lastname'][4])) {echo " error-border";} echo "'"?>
                      value="<?php if (isset($family[4]['lastname'])) {echo htmlspecialchars($family[4]['lastname']);} ?>" />
                  </div>


        				<?php } ?>
                <p class='sub-font'>Please provide an email address for confirmation.</p>
