<?php
	...
	//define('DB_LOGIN_NAME', 'timvasne_wedding_admin_login');    		// The name of the database
	//define('DB_LOGIN_USER', 'timvasne_user');     		// MySQL username
	//define('DB_LOGIN_PASSWORD', 'TjV.04*23'); 	// MySqlpassword
	//define('DB_LOGIN_HOST', 'timandkimberly.com');  // local HOST
	//define('DB_HOST', 'localhost');  // live HOST
